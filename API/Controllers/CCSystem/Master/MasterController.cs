...
namespace API.Controllers.CCSystem.Master
{
    ...
    public class MasterController : BaseApiController
    {
        ...
        // private readonly string MenuList = "MenuList";
        ...
        {
            // IEnumerable<MenuJoinList> menuList = null;
            // if(_cache.TryGetValue(MenuList, out menuList) == false)
            // {
            //     Console.WriteLine("Cache miss....loading from database into cache");
            //     menuList = await _masterRepository.GetMenuListAsync();

            //     _cache.Set("MenuList", menuList, TimeSpan.FromSeconds(10));
            // }
            // else
            // {
